...
train_data = train_data[train_data['x'] < 7e7]
...
ng = 1
gp= gaussian_process.GaussianProcess(theta0=0.5e-2, thetaL=1e-3, thetaU=0.5, nugget=ng, random_start=10)
...
x = np.atleast_2d(np.linspace(0, 4e7, 1000)).T
